<template>
  <section class="mx-auto max-w-7xl">
    <div class="container mx-auto max-w-lg px-4 py-32 text-left md:max-w-none md:text-center">
      <h1 class="text-left text-5xl font-extrabold leading-10 tracking-tight text-gray-900 sm:leading-none md:text-center md:text-6xl lg:text-7xl"><span class="inline md:block">Start Crafting Your</span> <span class="relative mt-2 bg-gradient-to-br from-indigo-600 to-indigo-500 bg-clip-text text-transparent md:inline-block">Next Great Idea</span></h1>
      ...
      <div class="mt-12 flex flex-col items-center text-center">
        <span class="relative inline-flex w-full md:w-auto">
          <a href="javascript:void(0)" type="button" class="inline-flex w-full items-center justify-center rounded-xl border border-transparent bg-indigo-600 px-8 py-4 text-base font-bold leading-6 text-white hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2 md:w-auto"> Purchase Now </a>
          <span class="absolute top-0 right-0 -mt-3 -mr-6 rounded-full bg-green-400 px-2 py-1 text-xs font-medium leading-tight text-white">only $15/mo</span>
        </span>
  ...
  <section class="bg-white px-2 py-32 md:px-0">
    <div class="container mx-auto max-w-7xl items-center px-8 xl:px-5">
      <div class="flex flex-wrap items-center sm:-mx-3">
        <div class="w-full md:w-1/2 md:px-3">
          <div class="w-full space-y-6 pb-6 sm:max-w-md sm:pr-5 md:space-y-4 md:pb-0 lg:max-w-lg lg:space-y-8 lg:pr-0 xl:space-y-9">
            ...
            <p class="mx-auto text-base text-gray-500 sm:max-w-md md:max-w-3xl lg:text-xl">It's never been easier to build beautiful websites that convey your message and tell your story.</p>
            <div class="relative flex flex-col sm:flex-row sm:space-x-4">
              <a href="javascript:void(0)" class="mb-3 flex w-full items-center rounded-xl bg-indigo-600 px-6 py-3 text-lg text-white hover:bg-indigo-700 sm:mb-0 sm:w-auto">
                Try It Free
              ...
              <a href="javascript:void(0)" class="flex items-center rounded-xl bg-gray-100 px-6 py-3 text-gray-500 hover:bg-gray-200 hover:text-gray-600"> Learn More </a>
            </div>
          </div>
        </div>
        <div class="w-full md:w-1/2">
          <div class="h-auto w-full overflow-hidden rounded-xl shadow-xl">
  ...
  <section class="bg-white py-20">
    <div class="container mx-auto max-w-7xl">
      <h2 class="text-center text-4xl font-bold tracking-tight">Our Features</h2>
      <p class="mt-2 text-center text-lg text-gray-600">Check out our list of awesome features below.</p>
      <div class="mt-10 grid grid-cols-4 gap-8 sm:grid-cols-8 sm:px-8 lg:grid-cols-12 xl:px-0">
        <div class="relative col-span-4 flex flex-col items-center justify-between space-y-4 overflow-hidden rounded-xl bg-gray-100 px-8 py-12">
          ...
          <p class="text-center text-base text-gray-500">Each of our plan will provide you and your team with certifications.</p>
        </div>

        <div class="col-span-4 flex flex-col items-center justify-between space-y-4 rounded-xl bg-gray-100 px-8 py-12">
          <div class="rounded-xl bg-blue-500 p-3 text-white">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
          ...
          <p class="text-center text-base text-gray-500">Send out notifications to all your customers to keep them engaged.</p>
        </div>
        ...
        <div class="col-span-4 flex flex-col items-center justify-between space-y-4 rounded-xl bg-gray-100 px-8 py-12">
          ...
          <p class="text-center text-base text-gray-500">High-quality bundles of awesome tools to help you out.</p>
        </div>
        ...
        <div class="col-span-4 flex flex-col items-center justify-between space-y-4 rounded-xl bg-gray-100 px-8 py-12">
          ...
          <p class="text-center text-base text-gray-500">Developer tools to help grow your application and keep it up-to-date.</p>
        </div>
        ...
        <div class="col-span-4 flex flex-col items-center justify-between space-y-4 rounded-xl bg-gray-100 px-8 py-12">
          ...
          <p class="text-center text-base text-gray-500">The right kind of building blocks to take your company to the next level.</p>
        </div>
        ...
        <div class="col-span-4 flex flex-col items-center justify-between space-y-4 rounded-xl bg-gray-100 px-8 py-12">
          ...
          <p class="text-center text-base text-gray-500">Coupons system to provide special offers and discounts for your app.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8">
      <div class="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
        <div class="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1">
          <svg class="h-12 fill-current text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 266 100">
        ...
        <div class="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1">
          <svg class="h-10 fill-current text-gray-500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 316 60">
        ...
        <div class="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1">
          <svg class="mt-2 h-8 fill-current text-gray-500" viewBox="0 0 398 120" xmlns="http://www.w3.org/2000/svg">
            <g fill-rule="nonzero">
        ...
        <div class="col-span-1 flex items-center justify-center md:col-span-3 lg:col-span-1">
          <svg class="mt-1 h-5 fill-current text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 278.7 36.3">
            <g>
              <path
                class="st0"
        ...
        <div class="col-span-2 flex items-center justify-center md:col-span-3 lg:col-span-1">
          <svg class="h-8 fill-current text-gray-500" viewBox="0 0 2270 546" xmlns="http://www.w3.org/2000/svg">
            <g fill-rule="evenodd">
              <path
